    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area',
                 models.CharField(choices=[('Orders', 'Orders'), ('Refunds', 'Refunds'), ('Catalog', 'Catalog')],
                                  db_index=True, help_text='Note: E.g. Order, Refund, Product', max_length=120,
                                  verbose_name='Notification Area')),
                ('trigger_action', models.CharField(
                    choices=[('NEW_ORDER', 'When New Order Placed'), ('DAILY_ORDER', 'Daily Order Value')],
                    db_index=True, max_length=255, verbose_name='Notification Trigger On')),
                ('type', models.CharField(choices=[('Sms', 'SMS'), ('Email', 'EMAIL'), ('Email_Sms', 'EMAIL/SMS')],
                                          db_index=True, max_length=255, verbose_name='Notification Channel')),
                ('sms_content',
                 models.TextField(blank=True, help_text='Note: Text message content either templating or plain text',
                                  max_length=255, null=True, verbose_name='SMS Message Content')),
                ('email_content', django_quill.fields.QuillField(blank=True,
                                                                 help_text='Note: Email message content either templating or plain text',
                                                                 null=True, verbose_name='Email Message Content')),
                ('frequency', models.PositiveSmallIntegerField(blank=True, db_index=True, default=1, null=True,
                                                               verbose_name='Notification Frequency')),
                ('time', models.TimeField(blank=True, db_index=True, null=True, verbose_name='At Time')),
                ('email_recipient', models.TextField(blank=True,
                ...
                ('sms_recipient', models.TextField(blank=True,
